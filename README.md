...
The current prebuilt release is **0.3.8**. Training-only sessions retain local
scores while remaining excluded from the toplist:

- **Linux x86_64 AppImage:** [qrq-0.3.8-linux-x86_64.AppImage](https://github.com/garyPenhook/qrq/releases/download/v0.3.8/qrq-0.3.8-linux-x86_64.AppImage).
  ...
  `~/.local/share/qrq`).
- **Linux x86_64 tarball:** [qrq-0.3.8-linux-x86_64.tar.gz](https://github.com/garyPenhook/qrq/releases/download/v0.3.8/qrq-0.3.8-linux-x86_64.tar.gz).
  ...
  libraries.
- **Windows x86_64:** [qrq-0.3.8-windows-x86_64-setup.exe](https://github.com/garyPenhook/qrq/releases/download/v0.3.8/qrq-0.3.8-windows-x86_64-setup.exe).
...
- Verify either download with [SHA256SUMS](https://github.com/garyPenhook/qrq/releases/download/v0.3.8/SHA256SUMS).
