...
- [~] Provide focused generators for digits, serial exchanges, prefixes,
  ...
  three-, four-, and five-digit serial exchanges, portable /P, /M, and /MM
  variants, plus operator-defined CW item lists are available; dedicated
  prefix and punctuation generators remain.
